...
<html lang="en">
  ...
  <body data-spy="scroll" data-offset="0" data-target="#theMenu">
	...
	<! -- ABOUT SEPARATOR -->
	<div class="sep about" data-stellar-background-ratio="0.5"><h1>World Traveller</h1></div>
	...
	<! -- PORTFOLIO SEPARATOR -->
	<div class="sep portfolio" data-stellar-background-ratio="0.5"><h1>Amateur Surfer</h1></div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8-offset-2 centered">
					...
					<h3>The list that keeps on growing</h3>
				</div><!-- /col-lg-8 -->
			</div><! --/row -->
			...
			<div class="row mt">
				...
				<div class="col-sm-3 service">
					...
					<p class="text">I just started using Github and I'm kicking myself for not starting earlier.</p>
				</div>
			</div><! --/row -->
